...
/**
 * Allows the mob mincer to be enchanted with DIGGER and WEAPON enchantments. See {@link EnchantmentMixin} and {@link EnchantmentHelperMixin} for further constraints.
 */
